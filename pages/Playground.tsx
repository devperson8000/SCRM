...
PlaygroundView.style = css`
  ...
  .split-handle::before {
    ...
    background: var(--line-strong, rgba(190, 230, 219, 0.2));
    pointer-events: none;
  }
  .split-handle:hover {
    background: transparent;
  ...
  .section-title {
    ...
    font-weight: 600;
    padding: 0.7em 0.9em;
    border-bottom: 1px solid var(--line, rgba(190, 230, 219, 0.12));
  ...
  .file-tree {
    border-right: 1px solid var(--line, rgba(190, 230, 219, 0.12));
    border-radius: 0;
  ...
  .origin-bar {
    ...
    border-top: 1px solid var(--line, rgba(190, 230, 219, 0.12));
  ...
  .origin-bar input:focus {
    ...
    box-shadow: 0 0 0 2px var(--accent-dim, rgba(0, 255, 136, 0.1));
  }
  .preview-omnibox {
    display: flex;
    align-items: center;
  ...
  .preview-tab.active {
    background: var(--accent-dim, rgba(0, 255, 136, 0.1));
    color: var(--accent-text, #00ff88);
    box-shadow: inset 0 -2px var(--accent, #00ff88);
  }
  .rewrite-meta {
    display: flex;
    align-items: center;
